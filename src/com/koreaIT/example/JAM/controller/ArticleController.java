...
public class ArticleController {
	...
	public void showDetail(String cmd) {
		...
		int id = articleService.getNumInCmd(cmd);  // 명령에서 id 추출

		Article article = articleService.showDetail(id); // 추출해온 id로 DB에서 해당 번호의 게시물을 꺼내온다.
	...
	public void doModify(String cmd) {
		...
		if(article.memberId != Session.getLoginedMemberId()) {
			System.out.printf("%d번 게시물에 대한 권한이 없습니다.", article.id);
			return;
		}
